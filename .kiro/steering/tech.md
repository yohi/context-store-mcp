...
*   **PostgreSQL 16 with pgvector 0.2.x**:
    ...
    *   **必須**: すべての動作モードで必要。
    *   **注意**: 指定されているバージョン0.2.xは古く（2021-2022年のメンテナンスリリースのみ）、最新の0.7.x以降（現在の安定版は0.8.0、2024年10月リリース）への更新を推奨します。0.7.0-0.8.0では、halfvec/sparsevec型、ビットベクトルインデックス、HNSW改善など、3年分の重要な機能強化が含まれています。
